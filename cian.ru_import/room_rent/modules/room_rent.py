...
######## ROOM RENT ADVERTISMENT DETAILS
    ...
    @property
    def room_for_sale_count (self):
        return self.__RoomsForSaleCount
    
    @room_for_sale_count.setter
    def room_for_sale_count (self, value):
        self.__RoomsForSaleCount = value
...
#######  EXPORT TO .XML FORMAT
    ...
    def as_xml(self):
        result = [
            ...
            f'<RoomsForSaleCount>{self.rooms_for_sale_count}</RoomsForSaleCount>'
            f'<RoomType>{self.room_type}</RoomType>',
            f'<RoomArea>{self.room_area}</RoomArea>'
            f'<RoomsCount>{self.rooms_count}</RoomsCount>',
