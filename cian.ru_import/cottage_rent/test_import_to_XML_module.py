...
from modules.cottage_rent import *


x = CottageRent()

x.land.area = '44'
x.land.area_unit_type = 'ar'
...
x.building.heating_type = '3'
x.building.cargo_lifts_count = '9'
x.building.has_garbage_chute = 'true'
x.building.parking_type = 'rr'
x.bargain_terms.utilities_terms.price = '2563'
x.bargain_terms.utilities_terms.included_in_price = '2258'
...
x.bargain_terms.tenants_type = 'all'
...
x.category='cottageRent'
x.settlement_name = 'SettlementName'
x.total_area='8752'
x.bedrooms_count = '22'
x.wc_location_type = '33'
x.repair_type='none'
x.has_internet='21'
x.has_furniture='no'
x.has_phone='no'
