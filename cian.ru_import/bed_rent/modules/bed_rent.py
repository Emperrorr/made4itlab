...
######## BED RENT ADVERTISMENT DETAILS
    ...
    @property
    def rooms_for_sale_count (self):
        return self.__RoomsForSaleCount
   
    @rooms_for_sale_count.setter
    def rooms_for_sale_count (self, value):
    ...
    @property
    def beds_count (self):
        return self.__BedsCount
    
    @beds_count.setter
    def beds_count (self, value):
        self.__BedsCount = value
